...
class InfoView : UITextView {
	...
	func ShowText(type : RPNCalcCmd) {
		...
		case .Sto1,.Sto:t = "Enter a variable name in x and store the current value of y."
		case .Rcl1,.Rcl:t = "Enter a variable name in x and recall the previous stored value"
